...
public class Result {
    ...
    public static final List<String> TASK_032_TOP_3_HIGHEST_PAID_EMPLOYEES = List.of(
            "Henry Ford", "Eve Adams", "Leo Nfor"
    );

    public static final List<String> TASK_033_SUPPORT_EMPLOYEE_EMAILS = List.of(
            "charlie@acme.io", "ivy@acme.io"
    );

    public static final List<String> TASK_034_DISTINCT_DEPARTMENTS_SORTED = List.of(
            "Engineering", "Finance", "HR", "Sales", "Support"
    );
    ...
    public static final List<String> TASK_038_EMPLOYEES_WITH_SALARY_AT_LEAST_5000 = List.of(
            "Bob Smith", "Eve Adams", "Henry Ford", "Leo Nfor"
    );
    ...
    public static final List<String> TASK_045_EMPLOYEES_WITH_JAVA_SKILL = List.of(
            "Alice Johnson", "Eve Adams", "Ivy Chen", "Leo Nfor"
    );

    public static final List<String> TASK_046_EMPLOYEES_WITH_JAVA_OR_SECURITY = List.of(
            "Alice Johnson", "Eve Adams", "Ivy Chen", "Leo Nfor"
    );
    ...
    public static final Map<String, Long> TASK_047_SKILL_FREQUENCY = Map.ofEntries(
            Map.entry("Java", 4L),
            Map.entry("Spring", 1L),
            Map.entry("PostgreSQL", 1L),
            Map.entry("Docker", 1L),
            Map.entry("Kubernetes", 1L),
            Map.entry("Linux", 1L),
            Map.entry("SQL", 1L),
            Map.entry("Troubleshooting", 1L),
            Map.entry("Excel", 1L),
            Map.entry("Compliance", 1L),
            Map.entry("Architecture", 1L),
            Map.entry("Security", 2L),
            Map.entry("CRM", 1L),
            Map.entry("Negotiation", 1L),
            Map.entry("Angular", 1L),
            Map.entry("TypeScript", 1L),
            Map.entry("UX", 1L),
            Map.entry("Leadership", 1L),
            Map.entry("Budgeting", 1L),
            Map.entry("Testing", 1L),
            Map.entry("Automation", 1L),
            Map.entry("Salesforce", 1L),
            Map.entry("Presentation", 1L),
            Map.entry("Hiring", 1L),
            Map.entry("Policy", 1L),
            Map.entry("OAuth2", 1L)
    );
    ...
    public static final Map<Long, BigDecimal> TASK_053_UNPAID_AMOUNT_BY_EMPLOYEE_ID = Map.of(
            1L, new BigDecimal("1200.00"),
            3L, new BigDecimal("800.00"),
            5L, new BigDecimal("3100.00"),
            10L, new BigDecimal("950.00"),
            12L, new BigDecimal("4200.00")
    );

    public static final List<Long> TASK_054_PAID_INVOICE_IDS = List.of(1002L, 1005L);

    public static final Map<Boolean, Long> TASK_055_INVOICE_COUNT_BY_PAID_STATUS = Map.of(
            true, 2L,
            false, 5L
    );
    ...
    public static final Map<Long, BigDecimal> TASK_061_TOTAL_INVOICE_AMOUNT_BY_EMPLOYEE_ID = Map.of(
            1L, new BigDecimal("1200.00"),
            2L, new BigDecimal("2200.00"),
            3L, new BigDecimal("800.00"),
            5L, new BigDecimal("3100.00"),
            8L, new BigDecimal("5000.00"),
            10L, new BigDecimal("950.00"),
            12L, new BigDecimal("4200.00")
    );
    ...
    public static final Map<String, Long> TASK_068_TRANSACTION_COUNT_BY_STATUS = Map.of(
            "SUCCESS", 6L,
            "FAILED", 4L
    );
    ...
    public static final Map<Long, BigDecimal> TASK_069_TOTAL_SUCCESSFUL_AMOUNT_BY_EMPLOYEE_ID = Map.of(
            ...
            2L, new BigDecimal("420.00"),
            5L, new BigDecimal("1200.00"),
            8L, new BigDecimal("1500.00"),
            12L, new BigDecimal("650.00")
    );

    public static final Map<Long, LocalDateTime> TASK_070_LATEST_TRANSACTION_TIME_BY_EMPLOYEE_ID = Map.of(
            1L, LocalDateTime.of(2026, 4, 20, 11, 0),
            2L, LocalDateTime.of(2026, 4, 21, 14, 40),
            5L, LocalDateTime.of(2026, 4, 22, 18, 20),
            8L, LocalDateTime.of(2026, 4, 22, 16, 5),
            10L, LocalDateTime.of(2026, 4, 23, 9, 0),
            12L, LocalDateTime.of(2026, 4, 23, 10, 10)
    );
    ...
    public static final Map<String, Long> TASK_073_TRANSACTION_COUNT_BY_TYPE = Map.of(
            "PAYMENT", 5L,
            "TRANSFER", 4L,
            "REFUND", 1L
    );
    ...
    public static final Map<Long, List<Long>> TASK_078_TRANSACTION_IDS_BY_EMPLOYEE_ID = Map.of(
            1L, List.of(2001L, 2002L),
            2L, List.of(2003L, 2004L),
            5L, List.of(2005L, 2006L, 2007L),
            8L, List.of(2008L),
            10L, List.of(2009L),
            12L, List.of(2010L)
    );
    ...
    public static final Map<String, BigDecimal> TASK_080_SUCCESSFUL_TRANSACTION_TOTALS_BY_TYPE = Map.of(
            "PAYMENT", new BigDecimal("2070.00"),
            "TRANSFER", new BigDecimal("1850.00")
    );
    ...
    public static final Map<String, Long> TASK_086_LOG_COUNT_BY_LEVEL = Map.of(
            "INFO", 2L,
            "WARN", 1L,
            "ERROR", 5L
    );
    ...
    public static final String TASK_100_JOINED_ERROR_LOG_MESSAGES = "Redis timeout | Invoice sync failed | Invalid token | Downstream unavailable | Payment mismatch";
    ...
    public static final Map<Long, BigDecimal> TASK_106_TOTAL_ORDER_VALUE_BY_EMPLOYEE_ID = Map.of(
            1L, new BigDecimal("1250.00"),
            2L, new BigDecimal("210.00"),
            5L, new BigDecimal("645.00"),
            8L, new BigDecimal("620.00"),
            12L, new BigDecimal("210.00")
    );
    ...
    public static final Map<String, Long> TASK_109_ORDER_COUNT_BY_STATUS = Map.of(
            "PAID", 3L,
            "PENDING", 1L,
            "CANCELLED", 1L
    );
